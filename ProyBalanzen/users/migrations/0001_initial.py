    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('MUJER', 'Mujer'), ('HOMBRE', 'Hombre'), ('OTRO', 'Otro')], default=None, max_length=10, null=True)),
                ('rol', models.CharField(choices=[('ADMIN', 'Admin'), ('TRABAJADOR', 'Trabajador'), ('CLIENTE', 'Cliente')], default='CLIENTE', max_length=15)),
                ('puntos_recompensa', models.IntegerField(default=0, verbose_name='Puntos de Recompensa')),
                ('nivel_membresia', models.CharField(choices=[('PLATA', 'Plata'), ('ORO', 'Oro'), ('PLATINO', 'Platino')], default='PLATA', max_length=10, verbose_name='Nivel de Membresía')),
