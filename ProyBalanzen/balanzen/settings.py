"""
Django settings for balanzen project.
...
ROOT_URLCONF = 'balanzen.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # RUTA DONDE SE GUARDAN LAS PLANTILLAS
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'balanzen.wsgi.application'
...
LOGIN_REDIRECT_URL = 'inicio_user'  # Ruta por defecto tras login
LOGOUT_REDIRECT_URL = 'home'  # Ruta tras logout
LOGIN_URL = 'login'  # Ruta del login (para @login_required)
